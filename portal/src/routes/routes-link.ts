export const URLItems = (): string => "/items";
export const URLItem = (id: string = ":id"): string => `/item/${id}`;

export const URLOrders = (): string => "/admin/orders";
export const URLChefOrders = (): string => "/admin/chef-orders";
export const URLCategories = (): string => "/admin/categories";
