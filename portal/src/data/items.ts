...
export const foods: Food[] =
  ...
  //     ],
  //     addOns: [
  //       { id: 1, name: "More Cheese", sellPrice: 50 },
  //       { id: 2, name: "More Naga", sellPrice: 20 },
  //       { id: 3, name: "Extra Patty - Chicken", sellPrice: 119 },
  //       { id: 4, name: "Extra Patty - Mutton", sellPrice: 149 },
  //     ],
  //     relatedItems: [
  //       {
  //         id: 2,
  ...
  //     ],
  //     addOns: [
  //       { id: 1, name: "More Cheese", sellPrice: 39 },
  //       { id: 2, name: "More Sauce", sellPrice: 29 },
  //       { id: 3, name: "Extra Patty - Chicken", sellPrice: 119 },
  //     ],
  //     relatedItems: [
  //       {
  ...
  //       { id: 1, name: "More Cheese", sellPrice: 50 },
  //       { id: 2, name: "More Sauce", sellPrice: 29 },
  //       { id: 3, name: "Extra Toppings", sellPrice: 99 },
  //     ],
  //     relatedItems: [
  //       {
  //         id: 1,
  ...
  //     ],
  //     addOns: [
  //       { id: 1, name: "Extra Patty", sellPrice: 119 },
  //       { id: 2, name: "More Cheese", sellPrice: 50 },
  //       { id: 3, name: "Extra Sauce", sellPrice: 29 },
  //     ],
  //     relatedItems: [
  //       {
  //         id: 3,
  ...
  //     ],
  //     addOns: [
  //       { id: 1, name: "Extra Sauce", sellPrice: 29 },
  //       { id: 2, name: "More Cheese", sellPrice: 50 },
  //     ],
  //     relatedItems: [
  //       {
  ...
  //     ],
  //     addOns: [
  //       { id: 1, name: "Extra Croutons", sellPrice: 20 },
  //       { id: 2, name: "More Dressing", sellPrice: 15 },
  //     ],
  //     relatedItems: [
  //       {
  //         id: 5,
  ...
  //     ],
  //     addOns: [
  //       { id: 1, name: "More Wasabi", sellPrice: 20 },
  //       { id: 2, name: "Extra Soy Sauce", sellPrice: 15 },
  //     ],
  //     relatedItems: [
  //       {
  //         id: 3,
  ...
  //     ],
  //     addOns: [
  //       { id: 1, name: "Extra Lemon", sellPrice: 15 },
  //       { id: 2, name: "More Garlic Butter", sellPrice: 29 },
  //     ],
  //     relatedItems: [
  //       {
  //         id: 8,
  ...
  //     ],
  //     addOns: [
  //       { id: 1, name: "More Mashed Potatoes", sellPrice: 50 },
  //       { id: 2, name: "Extra Sauce", sellPrice: 29 },
  //     ],
  //     relatedItems: [
  //       {
  //         id: 5,
  ...
  [
    ...
    },
    {
      ...
      addOns: [
        { id: 2101, name: "More Cheese", sellPrice: 50 },
        { id: 2102, name: "More Naga", sellPrice: 20 },
        { id: 2103, name: "Extra Patty - Chicken", sellPrice: 119 },
        { id: 2104, name: "Extra Patty - Mutton", sellPrice: 149 },
      ],
      relatedItems: [
        {
          id: 2,
