"""Notification context for table order rejected emails."""
...
def get_context(context):
    """Set the primary email recipient for table order rejected notifications.
    ...
    if not primary_email:
        frappe.log_error(
            message=f"No primary email found for Table Order Rejected {doc.name} (Customer: {doc.customer}) - skipping notification",
